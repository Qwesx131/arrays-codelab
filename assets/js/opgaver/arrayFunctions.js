...
let myNextNumbers = myNumbers.map(multipler7);
let myLastNumbers = myNextNumbers.map(multipler12)
function multipler7(value, index, arr) {
    return value * 7;
}

function multipler12(value, index, arr) {
    return value * 12;
}
...
let udenkeld = myNames.filter(kild)
